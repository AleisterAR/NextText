...
function copyClipboard(_x) {
  return _copyClipboard.apply(this, arguments);
}
function _copyClipboard() {
  _copyClipboard = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var copy;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return navigator.clipboard.writeText(copy.innerText);
        case 4:
          _context.next = 9;
          break;
        case 6:
